...
@Component({
  selector: 'TastingSession-home',
  templateUrl: './TastingSession-home.component.html',
  styleUrls: ['./TastingSession-home.component.scss']
})
export class TastingSessionHomeComponent implements AfterViewInit {
